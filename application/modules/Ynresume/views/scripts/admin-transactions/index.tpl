<script src="<?php $this->baseURL()?>application/modules/Ynresume/externals/scripts/picker/Locale.en-US.DatePicker.js" type="text/javascript"></script> 
<script src="<?php $this->baseURL()?>application/modules/Ynresume/externals/scripts/picker/Picker.js" type="text/javascript"></script> 
<script src="<?php $this->baseURL()?>application/modules/Ynresume/externals/scripts/picker/Picker.Attach.js" type="text/javascript"></script> 
<script src="<?php $this->baseURL()?>application/modules/Ynresume/externals/scripts/picker/Picker.Date.js" type="text/javascript"></script> 
<link href="<?php $this->baseURL()?>application/modules/Ynresume/externals/styles/picker/datepicker_dashboard.css" rel="stylesheet">
...
<table class='admin_table ynsocial_table' style="width: 100%">
  <thead>
    <tr>
      ...
      <th><a href="javascript:void(0);" onclick="javascript:changeOrder('resume.name', 'ASC');"><?php echo $this->translate('Resume') ?></a></th>
  ...
  <tbody>
    <?php foreach ($this->paginator as $item): ?>
      <tr>
        ...
        <?php endif;?>
        <td>
        	<?php $resume = Engine_Api::_() -> getItem('ynresume_resume', $item -> item_id); ?>
        	<?php if($resume) :?>
        		<?php echo $this->htmlLink($resume->getHref(), $resume->getTitle()); ?>
        	<?php else :?>
        		<i><?php echo $this->translate('Deleted resume'); ?></i>
        	<?php endif;?>
        </td>
