...
return array(
  '4.8.12' => array(
    'controllers/FriendsController.php' => 'Made unique name of hash element and Fixed issue of invalid token error coming after user right clicks on Friend Request links',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/friends/request-follow.tpl' => 'Added hash token value',
    'views/scripts/friends/request-friend.tpl' => 'Added hash token value',
    'Form/Friends.php' => 'Made unique name of hash element',
    'Form/Friends/*' => 'Made unique name of hash element',
    'Form/Signup/Account.php' => 'Added Event: onCheckBannedEmail'
  ),
  '4.8.11' => array(
    ...
    'controllers/AdminSettingsController.php' => 'Added missing Google Plus entry for Janrain',
    'controllers/AdminManageController.php' => 'Fixed issue with newly registered members are receiving two emails: "Welcome email" and Added hook: onUserDisable',
    'controllers/AuthController.php' => 'Fixed error being thrown out while integrating an SE account with an already integrated FB account.',
    'controllers/SettingsController.php' => 'Fixed issue with FConnect button not appearing on page just after unchecking the checkbox to dis-integrate facebook account and saving the settings and Fixed error being thrown out while integrating an SE account with an already integrated FB account.',
    'controllers/SignupController.php' => 'Fixed issue with newly registered members are receiving two emails: "Welcome email"',
    'externals/images/janrain/googleplus.png' => 'Added misssing Google Plus icon for Janrain',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'Form/Admin/Manage/Edit.php' => 'Added hash token field',
    'Form/Admin/Facebook.php' => 'Updated KB article link',
    'Form/Admin/Signup/Account.php' => 'Added setting for sending a welcome email when users are enabled from admin panel',
    'Form/Friends/*' => 'Added hash token field',
    'Form/Settings/General.php' => 'Fixed error being thrown out while integrating an SE account with an already integrated FB account.',
    'Model/User.php' => 'Added method: isAllowed',
    'Plugin/Core.php' => 'Fixed issue with newly registered members are receiving two emails: "Welcome email"',
    'Plugin/Signup/Account.php' => 'Fixed British English [en_GB] issue of locale field in sign up form not being saved correctly',
    'Plugin/Signup/Fields.php' => 'Added more user info (first name,last name, birthday and profile photo) to retrive from Facebook API during sign up',
    'Plugin/Menus.php' => 'Hide "Admin Settings" link for users who are not allowed to access admin panel',
  ),
  '4.8.10' => array(
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
