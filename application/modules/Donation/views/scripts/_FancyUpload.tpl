...
window.addEvent('domready', function() { // wait for the content
    ...
    var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
        ...
        url : '<?php echo  $this->url(array('controller' => 'photo', 'action' => 'uploadphotos', 'format' => 'json'), 'donation_extended')?>',
...
<fieldset id="demo-fallback">
    ...
    <p>
        <?php echo $this->translate('DONATION_FANCY_UPLOAD_DESCRIPTION');?>
    </p>
...
<div id="demo-status" class="hide">
    <div>
        <?php echo $this->translate('DONATION_UPLOAD_A_PHOTO_DESCRIPTION');?>
    </div>
    <div>
