...
return array(
  '4.8.9' => array(
    'controllers/AdminServicesController.php' => 'Redirected user to "Manage Storage Services" if "Edit Storage Service" is accessed when _ENGINE_ADMIN_NEUTER mode is enabled',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.8.5' => array(
    'Api/Storage.php' => 'Fixed wrong parameter names in Storage_Api_Storage::create()',
    'Service/S3.php' => 'Fixed a paramether in Storage_Service_S3::write()',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'settings/changelog.php' => 'Incremented version',
  ),
  '4.8.2' => array(
    'Service/Abstract.php' => 'Corrected a sprintf',
    'settings/my.sql' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
  ),
  '4.7.0' => array(
    'Model/File.php' => 'Fixed a warning',
    'settings/my.sql' => 'Incremented version',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
  ),
