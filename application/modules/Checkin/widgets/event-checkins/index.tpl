...
<script type="text/javascript">
  en4.core.runonce.add(function() {
    ...
    var anchor = $$('.layout_checkin_event_checkins')[0];
    ...
    $('page_checkin_previous').removeEvents('click').addEvent('click', function() {
      var url =  en4.core.baseUrl + 'widget/index/content_id/' + '<?php echo $this->identity ?>';
                ...
                <div class='feed_item_date feed_item_icon <?php echo $icon_type ?>'>
                  <ul>
                    ...
                    <li class="feed_item_option_is_checkin">
                      <p style="padding-left: 2px"><?php echo $this->translate('at ')?><a class="feed_item_checkin wall_tips" href="<?php echo $this->subject->getHref()?>" title="<?php echo $this->place->name ?>" target="_blank"><?php echo $this->subject->getTitle()?></a></p>
                    </li>
