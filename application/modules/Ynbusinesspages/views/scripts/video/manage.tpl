	...
	<div class="generic_layout_container layout_middle">
		...
		<div class="ynbusinesspages-profile-module-header">
            ...
            <div class="ynbusinesspages-profile-header-right">
				...
				<?php echo $this->htmlLink(array('route' => 'ynbusinesspages_extended', 'controller'=>'video','action'=>'list','subject' => $this->subject()->getGuid()), '<i class="fa fa-list"></i>'.$this->translate('Browse Videos'), array(
