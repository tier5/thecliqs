...
<script type="text/javascript">
	...
	function initialize() {
		var mapOptions = {
	  	...
	  	map = new google.maps.Map(document.getElementById('layout_ynjobposting_list_most_items-map-canvas'),mapOptions);
...
<div id="layout_ynjobposting_list_most_items-map-canvas" style="height: 450px;"></div>
<?php else:?>
	<div class="tip">
        <span>
            <?php echo $this->translate("There are no results found on this map") ?>
        </span>
    </div>
<?php endif;?>