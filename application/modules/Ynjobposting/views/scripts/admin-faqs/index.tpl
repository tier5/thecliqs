...
function deleteSelected(){
    ...
    $('multidelete').action = en4.core.baseUrl +'admin/ynjobposting/faqs/multidelete';
...
<p>
	<?php echo $this->translate("YNJOBPOSTING_MANAGE_FAQ_DESCRIPTION") ?>
</p>

<div class="add_link">
<?php echo $this->htmlLink(
array('route' => 'admin_default', 'module' => 'ynjobposting', 'controller' => 'faqs', 'action' => 'create'),
  ...
  <tbody>
    <?php foreach ($this->paginator as $item): ?>
      <tr>
        ...
        <td>
              <?php echo $this->htmlLink(
                    array('route' => 'admin_default', 'module' => 'ynjobposting', 'controller' => 'faqs', 'action' => 'edit', 'id' => $item->faq_id),
                    $this->translate('edit')
              )?>
              |
              <?php echo $this->htmlLink(
                    array('route' => 'admin_default', 'module' => 'ynjobposting', 'controller' => 'faqs', 'action' => 'delete', 'id' => $item->faq_id),
