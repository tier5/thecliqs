...
<script type="text/javascript">
  window.addEvent('domready', function() {
  	...
  	if ($('sponsor')) {
        $('sponsor').addEvent('click', function() {
           if (this.checked) {
               $('sponsor_period').set('disabled', false);
               $('sponsor_period').removeClass('disabled');
           }
           else {
               $('sponsor_period').set('disabled', true);
               $('sponsor_period').addClass('disabled');
           } 
        });
  	}
