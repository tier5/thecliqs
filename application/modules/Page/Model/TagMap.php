 ...
 * @license    http://www.socialengine.net/license/
 */
class Page_Model_TagMap extends Core_Model_Item_Abstract
{
  ...
  {
    return Engine_Api::_()->getItem('page_tag', $this->tag_id);
  }
  ...
  {
    return Engine_Api::_()->getItem($this->resource_type, (int)$this->resource_id);
  }
}