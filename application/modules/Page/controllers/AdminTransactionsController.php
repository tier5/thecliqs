 ...
 * @version    $Id: AdminBadgesController.php 8221 2011-01-15 00:24:02Z john $
 ...
 * @license    http://www.socialengine.net/license/
 */
class Page_AdminTransactionsController extends Core_Controller_Action_Admin
{
  public function indexAction()
  {
    $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
      ->getNavigation('page_admin_main', array(), 'page_admin_main_transactions');
