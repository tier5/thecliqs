      ...
      <?php foreach( $this->paginator as $item ):
        ...
        <tr>
          ...
          <td class='admin_table_centered'>
            <?php if( $package ): ?>
              <a href='<?php echo $this->url(array('action' => 'edit', 'package_id' => $package->package_id),'ynpayment_admin_plan', true) ?>'>
          ...
          <td class='admin_table_centered'>
            <a href='<?php echo $this->url(array('module' => 'authorization', 'controller' => 'level', 'action' => 'edit', 'id' => $level->level_id),'admin_default', true) ?>'>
