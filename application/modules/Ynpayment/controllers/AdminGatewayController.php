<?php
class Ynpayment_AdminGatewayController extends Core_Controller_Action_Admin
{
  public function init()
  {
  	$this -> view -> navigation = $navigation = Engine_Api::_() -> getApi('menus', 'core') -> getNavigation('ynpayment_admin_main', array(), 'ynpayment_admin_main_getways');
  }
