<?php
class Ynlistings_Model_Post extends Core_Model_Item_Abstract
{
  protected $_searchTriggers = false;
  protected $_parent_type = 'ynlistings_topic';
  ...
  {
    return Engine_Api::_()->getItem('ynlistings_topic', $this->topic_id);
  }
  ...
  protected function _postInsert()
  {
    ...
    // Update topic
    $table = Engine_Api::_()->getDbtable('topics', 'ynlistings');
