		...
		<li class='ynmenu-level2-idmenu-<?php echo $menu2->submenu_id; ?>' <?php if(!empty($menu2_main_menu_background_color)):?> style="background-color:<?php echo "#".$menu2_main_menu_background_color;?>"<?php endif;?> data-level=2>
			...
			>
					...
					<?php if(empty($menu2_main_menu_text_color)):?>
						<span class="text"><?php echo $this -> translate($menu2->label);?></span>
					<?php else: ?>
						<span style="color:<?php echo "#".$menu2_main_menu_text_color; ?>" class="text"><?php echo $this -> translate($menu2->label);?></span>	
					<?php endif;?>
			</a>
			<?php if (count($menu2->children)) :?>
				<ul>
						...
						<li class='ynmenu-level3-idmenu-<?php echo $menu3->submenu_id; ?>' <?php if(!empty($menu3_main_menu_background_color)):?> style="background-color:<?php echo "#".$menu3_main_menu_background_color;?>"<?php endif;?> data-level=3>
							...
							>
								...
								<?php if(empty($menu3_icon)):?>
									<span class="ynmenu-icon"><i class="fa fa-cog"></i></span>
								<?php else: ?>
									<span class="ynmenu-icon"><i><?php echo $this->htmlImage($menu3_icon);?></i></span>	
								<?php endif;?>
								...
								<?php if(empty($menu3_hover_active_icon)):?>
									<span class="ynmenu-icon-hover"><i class="fa fa-cog"></i></span>
								<?php else: ?>
									<span class="ynmenu-icon-hover"><i><?php echo $this->htmlImage($menu3_hover_active_icon);?></i></span>	
								<?php endif;?>
								
								<!-- label -->	
								<?php if(empty($menu3_main_menu_text_color)):?>
									<span class="text"><?php echo $this -> translate($menu3->label);?></span>
								<?php else: ?>
									<span style="color:<?php echo "#".$menu3_main_menu_text_color; ?>" class="text"><?php echo $this -> translate($menu3->label);?></span>	
								<?php endif;?>
							</a>
						</li>
						<?php endif;?>
