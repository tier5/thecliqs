UPDATE `engine4_core_modules` SET `version` = '4.02p3' where 'name' = 'yncontest';

DELETE FROM `engine4_core_menuitems` WHERE `name` = 'yncontest_admin_main_gateway';

DROP table  IF EXISTS  `engine4_yncontest_gateways`;
