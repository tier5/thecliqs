<div id="ynmusic-music-listing-widget" class="music-listing">

	<div class="ynmusic-block-count-mode-view <?php if (empty($this->mode_enabled)) echo 'not-mode-view'?>">
		<?php $totalCount = $this->artistPaginator->getTotalItemCount() + $this->albumPaginator->getTotalItemCount() + $this->playlistPaginator->getTotalItemCount() + $this->songPaginator->getTotalItemCount();?>
		<div id="ynmusic-total-item-count"><?php echo $this->translate(array('%s Result', '%s Results', $totalCount), $totalCount)?></div>
	...
	<div id="ynmusic-listing-content-<?php echo $this ->identity;?>" class="ynmusic-listing-content">
		<?php echo $this->partial('_artist-listing.tpl', 'ynmusic', array('paginator' => $this->artistPaginator, 'formValues' => $this->formValues));?>
		<?php echo $this->partial('_album-listing.tpl', 'ynmusic', array('paginator' => $this->albumPaginator, 'formValues' => $this->formValues));?>
		<?php echo $this->partial('_playlist-listing.tpl', 'ynmusic', array('paginator' => $this->playlistPaginator, 'formValues' => $this->formValues));?>
		<?php echo $this->partial('_song-listing.tpl', 'ynmusic', array('paginator' => $this->songPaginator, 'formValues' => $this->formValues));?>
	</div>
</div>
