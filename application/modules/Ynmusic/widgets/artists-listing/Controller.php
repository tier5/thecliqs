<?php
class Ynmusic_Widget_ArtistsListingController extends Engine_Content_Widget_Abstract {
	public function indexAction() {
		...
		$paginator = Engine_Api::_()->getDbTable('artists', 'ynmusic')->getArtistsPaginator(array('admin'=>true) + $params);
		$paginator->setCurrentPageNumber($page);
		$paginator->setItemCountPerPage(Engine_Api::_()->getApi('settings', 'core')->getSetting('ynmusic_artistsPerPage', 8));	
