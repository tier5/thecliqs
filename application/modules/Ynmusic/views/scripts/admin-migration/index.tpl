...
<ul class="item-tab">
	<li id="item-tab-album" class="active"><a href="<?php echo $this->url(array('module'=>'ynmusic','controller'=>'migration'), 'admin_default', true)?>"><?php echo $this->translate('Albums')?></a></li>
	<li id="item-tab-playlist"><a href="<?php echo $this->url(array('module'=>'ynmusic','controller'=>'migration','action'=>'playlist'), 'admin_default', true)?>"><?php echo $this->translate('Playlists')?></a></li>
</ul>
    ...
    <table class='admin_table'>
        <thead>
            <tr>
                ...
                <th><a href="javascript:void(0);" onclick="javascript:changeOrder('object.title', 'ASC');"><?php echo $this->translate("Album") ?></a></th>
...
<?php else: ?>
<div class="tip">
    <span><?php echo $this->translate("There are no albums can import.") ?></span>
</div>
<?php endif; ?>
