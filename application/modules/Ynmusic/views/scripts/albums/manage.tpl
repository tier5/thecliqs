<div class="ynmusic-block-count-mode-view not-mode-view">
	<div id="ynmusic-total-item-count">
		<?php echo $this->translate(array('ynmusic_album_count_num_ucf', '%s Albums', $this->paginator->getTotalItemCount()), $this->paginator->getTotalItemCount())?>
	</div>
</div>
	
<div id="ynmusic-manage-album" class="ynmusic-listing-content manage-music">
