...
.layout_sdtopbarmenu_topbar_mini_menu_only {
	width: 100%;
}
.layout_sdtopbarmenu_topbar_mini_menu_only .layout_core_menu_mini {

  width: $theme_topbar_minimenu_width;
  margin: 0px auto 0px auto;
  overflow: hidden;
}
.layout_sdtopbarmenu_topbar_mini_menu_only .layout_core_menu_mini #core_menu_mini_menu {
    margin: 0 auto;
    overflow: hidden;
    width: $theme_topbar_minimenu_width;
	padding:0px;
}
.layout_sdtopbarmenu_topbar_mini_menu_only .layout_core_menu_mini #core_menu_mini_menu > ul > li + li {
	
	margin-top: 10px !important;
}
.layout_sdtopbarmenu_topbar_mini_menu_only .layout_core_menu_mini > div > ul {
	padding: 0px;
...
.layout_core_menu_mini .sd_pulldown_contents ul > li {
	cursor: default;
}
.layout_core_menu_mini .sd_pulldown_contents ul > li > span{
	cursor: pointer;
}
.layout_core_menu_mini ul#sd_notifications_menu_request > li .sd_buttons {
  float: right;
  margin-top: -10px;
  margin-bottom: 3px;
  cursor: default;	
}
.layout_core_menu_mini ul#sd_notifications_menu_request > li .sd_buttons button {
...
.layout_core_menu_mini ul#sd_notifications_menu_request > li .sd_buttons button:hover {
...
.layout_core_menu_mini .frequest_heading,
.layout_core_menu_mini .message_heading {
...
.layout_core_menu_mini .frequest_heading > a,
.layout_core_menu_mini .message_heading > a {
	font-size: 12px;
}
.layout_core_menu_mini #layout_core_menu_main_user {
	margin-left: 30px;	
}
