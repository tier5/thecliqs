 ...
 * @license    http://www.socialengine.net/license/
 */
class Experts_Payment_Transaction
{
  // Constants
  ...
  public function process(Experts_Payment_Gateway $gateway)
  {
    if( null !== $this->_driver && $this->_driver !== $gateway->getDriver() ) {
      throw new Experts_Payment_Exception('Already processed, cannot process with a different driver');
    }
