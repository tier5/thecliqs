...
{tab=this.get('rel');var time=["tab_listings_recent","tab_listings_popular","tab_listings_browse_listings"];var flag=time.indexOf(tab);if(flag>=0)
{if(document.getElementById('ynlistings_list_item').get('class')=='ynlistings_map-view')
document.getElementById('ynlistings_list_item').set('class','ynlistings_list-view');document.getElementById('list-most-items-iframe').style.display='none';}
tabinstance.expandtab(this)
tabinstance.cancelautorun()
var tab_heads=document.getElementById('yn_listings_tab_list').getChildren();for(i=0;i<tab_heads.length;i++)
{if(tab_heads[i].hasClass('active'))
{tab_heads[i].removeClass('active');}}
var tab_head_selected=document.getElementsByClassName('selected')[0];if(tab_head_selected){tab_head_selected.parentNode.addClass('active');}
return false}
