...
var auth = {};
var url = en4.core.baseUrl+'admin/ynlistings/imports/import-one-by-one';
...
<?php endif; ?>
<h2><?php echo $this->translate('Import Listings') ?></h2>
<a href="<?php echo $this->url(array('module'=>'ynlistings','action'=>'view-history'),'admin_default')?>"><?php echo $this->translate('View Import History')?></a>
<p><?php echo $this->translate("YNLISTINGS_ADMIN_IMPORT_DESCRIPTION") ?></p>      
<br/>
<div class='clear'>
    <div class='settings'>
