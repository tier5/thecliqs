...
class Ynlistings_Form_EmailToFriends extends Engine_Form
{
	...
	public function init() {
		...
		// Init form
		$this -> setTitle('Email To Friends') -> setDescription('YNLISTINGS_EMAIL_TO_FRIENDS_DESCRIPTION') -> setLegend('');
