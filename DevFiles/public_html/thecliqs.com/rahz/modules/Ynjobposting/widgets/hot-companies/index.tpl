...
<div class="ynjobposting-hot-companies flexslider ynjobposting-clearfix">
<ul class="slides">
<?php foreach ($this->companies as $company):?>
	<li class="ynjobposting-hot-companies-item">
		<?php echo Engine_Api::_()->ynjobposting()->getPhotoSpan($company); ?>
		<div class="ynjobposting-hot-companies-item-title">
...
<script type="text/javascript">
    ...
    jQuery(window).load(function() {
        var flex_width = jQuery('.ynjobposting-hot-companies').width();

        flex_width = Math.floor(flex_width / (Math.floor(flex_width/200)));
        
        jQuery('.ynjobposting-hot-companies').flexslider({
            animation: "slide",
            animationLoop: false,
