var SL_Slider = new Class({
	...
	initialize: function(options) {
		...
		if(self.options.playBtn != null) {
			//self.pauseIt();
      self.options.playBtn.removeClass('products_play_btn');
      self.options.playBtn.addClass('products_pause_btn');
	...
	start: function() {
        ...
        self.options.playBtn.addClass('products_pause_btn');
			...
			//self.pauseIt();
			if(self.options.playBtn) {
        self.options.playBtn.removeClass('products_pause_btn');
        self.options.playBtn.addClass('products_play_btn');
      }
		}
	},
