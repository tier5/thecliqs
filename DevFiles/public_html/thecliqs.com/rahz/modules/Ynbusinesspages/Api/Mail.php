...
class Ynbusinesspages_Api_Mail {
	/**
 ...
 public function create()
  {
	 ...
	 */
  	public function getTemplate($type, $locale = 'en') {
		...
		$table = Engine_Api::_()->getDbtable('MailTemplates', 'ynbusinesspages');
    ...
    $mailTemplateTable = Engine_Api::_()->getDbtable('MailTemplates', 'ynbusinesspages');
	...
	$vars = array();
    $params = Engine_Api::_()->getApi('ConvertMailVars', 'ynbusinesspages')->process($params, $vars, $type);
  ...
  public function sendRaw($mail) {
	...
	public function sendMailQueue($send_limit =  NULL){
		...
		$table =Engine_Api::_()->getDbTable('emails','ynbusinesspages');
