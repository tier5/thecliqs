<?php
class Ynbusinesspages_Widget_BusinessProfileClassifiedsController extends Engine_Content_Widget_Abstract {
	...
	public function indexAction() {
        ...
        //check auth create
        $viewer = Engine_Api::_() -> user() -> getViewer();
        $canCreate = $business -> isAllowed('classified_create');
