...
<div class="ynbusinesspages-profile-cover">
	...
	<div class="ynbusinesspages-profile-content">		
		...
		<div class="ynbusinesspages-profile-content-information">			
			...
			<?php $websiteURl = $this->subject()->web_address[0]; ?>
			<?php if((strpos($websiteURl,'http://') === false) && (strpos($websiteURl,'https://') === false)) $newWebsiteURl = 'http://'.$websiteURl; ?>
			<div class="ynbusinesspages-profile-item-info"><span><?php echo $this -> translate('Website');?>:</span> <a target="_blank" href="<?php echo $newWebsiteURl; ?>"><?php echo $websiteURl;?></a></div>
		</div>		
