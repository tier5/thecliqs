...
<script type="text/javascript">
    Wall.runonce.add(function () {
        var feed = new Wall.Feed({
            ...
            url_wall:'<?php echo $this->url(array('module' => 'core', 'controller' => 'widget', 'action' => 'index', 'name' => 'timeline.feed'), 'default', true) ?>',
            last_id: <?php echo sprintf('%d', $this->firstid) ?>,
            last_date:'<?php echo $this->firstdate; ?>',
            subject_guid:'<?php echo $this->subjectGuid ?>'
        });

        feed.compose.is_timeline = (Boolean)(<?php echo (int)$this->composerOnly; ?>);
...
<div class="wall-stream-header">
    <ul class="wall-stream-types">
        ...
        <li>
            <a href="javascript:void(0);"
               class="<?php if ($tab == $tab_default): ?>is_active<?php endif;?> wall-stream-type wall-stream-type-<?php echo $tab;?> wall_blurlink <?php if ($tab != 'welcome' && $tab != 'social'): ?>wall_notitle wall_tips<?php endif;?>"
               rev="<?php echo $tab;?>" <?php if ($tab != 'welcome' && $tab != 'social'): ?>title="<?php echo $this->translate('WALL_STREAM_' . strtoupper($tab));?>"<?php endif;?>>
    ...
    <ul class="wall-stream-options">
        ...
        <li class="wall-stream-option wall-stream-option-facebook">
            ...
            <ul class="wall-options">
                ...
                <li>
                    <a href="javascript:Wall.services.get('facebook').logout();"
