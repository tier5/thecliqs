<?php
class Ynpayment_AdminSubscriptionController extends Core_Controller_Action_Admin
{
  public function init()
  {
  	$this -> view -> navigation = $navigation = Engine_Api::_() -> getApi('menus', 'core') -> getNavigation('ynpayment_admin_main', array(), 'ynpayment_admin_main_subscription');
  }
  public function indexAction()
  {
    ...
    // Check for enabled payment gateways
      ...
      $this->view->error = $this->view->translate('There are currently no ' .
          ...
          $this->view->escape($this->view->url(array(), 'ynpayment_admin_gateway', true)) .
          '">', '</a>');
    }
