  ...
  'package' => array(
    ...
    'changeLog' => array(
      '4.8.10' => array(
        ...
        'Db/Select.php' => 'Improved regex for SQL group, order, from',
      ),
      '4.8.7' => array(
        'Locale*' => 'Added South Sudan to the list of countries.',
        'manifest.php' => 'Incremented version',
      ),
      '4.8.0' => array(
      ...
      '4.7.0' => array(
        'Service/ReCaptcha.php' => 'Updated the API URL',
        'Translate/Adapter.php' => 'Fixed a warning',
        'manifest.php' => 'Incremented version',
      ),
      '4.5.0' => array(
