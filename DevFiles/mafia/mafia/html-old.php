...
<script language="JavaScript1.2" src="truepimpz.js"></script>
...
background: #242424 url('gfx/rd.gif');
...
<body bgcolor="#666666" background="gfx/background.jpg" text="#FFFFFF" leftmargin="8" topmargin="8" marginwidth="8" marginheight="8" style="background-repeat: repeat;">
...
<center>
	...
	<table border=0 cellpadding=0 cellspacing=0 width="100%" align="center"><tr height=36><td style="border-top: 1px solid #868686; border-left: 1px solid #000; border-right: 1px solid #000" background="gfx/rd.gif">
	...
	<center>
		...
		<td width=5><img src="gfx/-.gif" width=5 height=1></td><td><a href="play.php"><img src="images/play.jpg" border=0></a></td>

		<td width=5><img src="gfx/-.gif" width=5 height=1></td><td width=13>&nbsp;</td>



				<td width=5><img src="gfx/-.gif" width=5 height=1></td><td><a href="myaccount.php"><img src="images/account.jpg" border=0></a></td>

		<td width=5><img src="gfx/-.gif" width=5 height=1></td><td width=13>&nbsp;</td>



				<td width=5><img src="gfx/-.gif" width=5 height=1></td><td><a href="credits.php"><img src="images/turns.jpg" border=0></a></td>

		<td width=5><img src="gfx/-.gif" width=5 height=1></td><td width=13>&nbsp;</td>



		<td width=5><img src="gfx/-.gif" width=5 height=1></td><td><a href="logout.php"><img src="images/logout.jpg" border=0></a></td>
...
?>
  ...
  <?if($user[0] == admin){?>
  <tr>
   <td height="12" align="center" bgcolor="000000"><h2>Administration</h2>
     <ul>
