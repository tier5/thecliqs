 ...
 * @version    $Id: Gateway.php 27.07.11 15:15 taalay $
 * @author     Taalay
 */
...
class Page_Model_Gateway extends Core_Model_Item_Abstract
{
  ...
  public function getPlugin()
  {
    if( null === $this->_plugin ) {
      ...
      if( !($plugin instanceof Engine_Payment_Plugin_Abstract) ) {
        throw new Engine_Exception(sprintf('Page plugin "%1$s" must ' .
