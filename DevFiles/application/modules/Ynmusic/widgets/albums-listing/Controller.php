<?php
class Ynmusic_Widget_AlbumsListingController extends Engine_Content_Widget_Abstract {
	public function indexAction() {
		...
		$paginator = Engine_Api::_()->getDbTable('albums', 'ynmusic')->getAlbumsPaginator($params);
