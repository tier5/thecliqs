<?php
class Ynmusic_Widget_UserProfileSongsController extends Engine_Content_Widget_Abstract {
	...
	public function indexAction() {
		...
		$paginator = Engine_Api::_()->getDbTable('songs', 'ynmusic')->getSongsPaginator(array('user_id'=>$subject->getIdentity()));
