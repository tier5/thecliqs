<div id="ynmusic-artists-listing-widget" class="music-listing">

    <div class="ynmusic-block-count-mode-view <?php if (empty($this->mode_enabled)) echo 'not-mode-view'?>">
    	<div id="ynmusic-total-item-count"><?php echo $this->translate(array('ynmusic_artist_count_num_ucf', '%s Artists', $this->paginator->getTotalItemCount()), $this->paginator->getTotalItemCount())?></div>
	...
	<div id="ynmusic-listing-content-<?php echo $this ->identity;?>" class="ynmusic-listing-content">
		<?php echo $this->partial('_artist-listing.tpl', 'ynmusic', array('paginator' => $this->paginator, 'formValues' => $this->formValues, 'paging' => true));?>
	</div>
</div>
