...
<?php echo $this->htmlLink(
    array('route' => 'admin_default', 'module' => 'ynmusic', 'controller' => 'migration-semusic'),
    ...
    <table class='admin_table'>
        ...
        <?php foreach ($this->paginator as $item): ?>
            <tr id="import-item_<?php echo $item->import_id?>">
				...
				<?php if ($canUpdate) :?>
				<?php echo $this->htmlLink(
				    array('route' => 'admin_default', 'module' => 'ynmusic', 'controller' => 'migration-semusic', 'action' => 'update-songs', 'id' => $item->import_id),
               	...
               	<?php if (!in_array($item->status, array('processing','updating'))) :?>
               		<?php echo $this->htmlLink(
					    array('route' => 'admin_default', 'module' => 'ynmusic', 'controller' => 'migration-semusic', 'action' => 'remove', 'id' => $item->import_id),
