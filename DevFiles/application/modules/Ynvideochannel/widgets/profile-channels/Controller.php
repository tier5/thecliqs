 ...
 */
class Ynvideochannel_Widget_ProfileChannelsController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $this->view->paginator = $paginator = $table->getChannelsPaginator(array(
