 ...
 * @version    $Id: _FancyUploadPhoto.tpl 2012-02-17 17:07:11 taalay $
 * @author     Taalay
 */
?>
...
window.addEvent('domready', function() { // wait for the content
	var up_photo = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
    ...
    policyFile : '<?php echo (_ENGINE_SSL ? 'https://' : 'http://')
      . $_SERVER['HTTP_HOST'] . $this->url(array(
		...
		url: $('form-upload').action + '?gift_type=photo',
    ...
    multiple: false,
        ...
        up_photo.remove(); // remove all files
				var photo = document.getElementById('fancyuploadphoto');
    ...
    onFileRemove: function(file) {
      ...
      var photo = document.getElementById('fancyuploadphoto');
        ...
        $('demo-browse').style.display = 'block';
		  ...
		  photo.value = photo.value.replace(file_id, "");
		},
      ...
      up_photo.start();
		...
		onFileSuccess: function(file, response) {
			...
			if (json.get('status') == '1') {
				...
				var photo = document.getElementById('fancyuploadphoto');
        photo.value = photo.value + json.get('photo_id') + " ";
...
<input type="hidden" name="fancyuploadphoto" id="fancyuploadphoto" value ="" />
<fieldset id="demo-fallback">
  ...
  <label for="demo-photoupload">
    ...
    <input type="file" name="Filedata" id="demo-photoupload" />
  </label>
</fieldset>

<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('HEGIFT_Add Photo DESC');?>
  </div>
  <div>
    <a class="buttonlink icon_photo_gift" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add Photo');?></a>
