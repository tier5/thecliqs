 ...
 * @version    $Id: _formManageGiftPhoto.tpl 2012-02-06 00:11:15Z TeaJay $
 * @author     Taalay
 */
?>
<?php if( $this->subject()->photo_id !== null ): ?>
  ...
  <?php
    if( strpos($this->subject()->getPhotoUrl(), '.gif') === false ) :
  ?>
  <?php
    $this->headScript()
  ...
  <div>
    <?php echo $this->itemPhoto($this->subject(), 'thumb.normal', "", array('id' => 'lassoImg', 'style' => 'max-width: 80px; max-height: 90px')) ?>
  </div>
  <br />
