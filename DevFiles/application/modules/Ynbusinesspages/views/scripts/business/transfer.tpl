...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    if( !isPopulated ) { // NOT POPULATED
      new Autocompleter2.Request.JSON('to', '<?php echo $this->url(array('controller' => 'member', 'action' => 'suggest','business_id'=>$this->business_id), 'ynbusinesspages_extended', true) ?>', {
        'minLength': 1,
        'delay' : 250,
        'selectMode': 'pick',
...
?>
<h3><?php echo $this->translate("Business Owner Transfer");?></h3>
<?php $this->form -> setTitle('');
