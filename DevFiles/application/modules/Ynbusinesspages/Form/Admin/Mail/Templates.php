...
class Ynbusinesspages_Form_Admin_Mail_Templates extends Engine_Form
{
  public function init()
  {
    ...
    foreach( Engine_Api::_()->getDbtable('MailTemplates', 'ynbusinesspages')->fetchAll() as $mailTemplate ) {
