                ...
                <div class="ynresume-user-item-footer">
                    ...
                    <div class="ynresume-user-item-action">
                        ...
                        <ul class="ynresume-show-options">
                            ...
                            <li><a id="ynresume_save_<?php echo $resume -> getIdentity();?>" onclick="saveResume('<?php echo $resume -> getIdentity() ;?>');" href="javascript:;"><i class="fa fa-floppy-o"></i><?php echo ($resume -> hasSaved())? $this -> translate('Unsave Resume') : $this -> translate('Save Resume');?></a></li>
                            <li><a href="javascript:void(0)"id="ynresume_favourite_<?php echo $resume -> getIdentity();?>" onclick="favouriteResume(this, '<?php echo $resume -> getIdentity() ;?>');"><i class="fa fa-star-o"></i><?php echo $this -> translate('Unfavourite');?></a></li>
...
<script type="text/javascript">
    ...
    function favouriteResume(obj, id)
	{
		new Request.JSON({
