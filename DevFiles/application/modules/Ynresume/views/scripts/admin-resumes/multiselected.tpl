...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate($this->action.' the selected resumes?') ?></h3>
      <p>
        <?php echo $this->translate('Are you sure that you want to '.lcfirst($this->action).' selected resumes?') ?>
      </p>
      <br />
      <p>
  ...
  <form>
    <div>
      <h3><?php echo $this->translate($this->action.' the selected resumes?') ?></h3>
      <p>
        <?php echo $this->translate('Please select at least one resume to '.lcfirst($this->action).'.') ?>
      </p>
      <br/>
