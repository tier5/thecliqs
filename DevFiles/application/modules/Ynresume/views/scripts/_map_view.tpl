...
<script type="text/javascript">
	...
	function initialize() {
		var mapOptions = {
	  	...
	  	map = new google.maps.Map(document.getElementById('layout_ynresume_resume_listing-map-canvas'),mapOptions);
...
<div id="layout_ynresume_resume_listing-map-canvas" style="height: 450px;"></div>
<?php else:?>
	<div class="tip">
        <span>
            <?php echo $this->translate("There are no resumes view on this map") ?>
        </span>
    </div>
<?php endif;?>