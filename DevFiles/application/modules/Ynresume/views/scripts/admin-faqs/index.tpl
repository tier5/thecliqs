...
function deleteSelected(){
    ...
    $('multidelete').action = en4.core.baseUrl +'admin/ynresume/faqs/multidelete';
...
<p><?php echo $this->translate("YNRESUME_FAQ_MANAGE_DESCRIPTION") ?></p>

<div class="add_link">
<?php echo $this->htmlLink(
    array('route' => 'admin_default', 'module' => 'ynresume', 'controller' => 'faqs', 'action' => 'create'),
    ...
    <table class='admin_table'>
        ...
        <?php foreach ($this->paginator as $item): ?>
            <tr>
                ...
                <td>
                <?php echo $this->htmlLink(
                    array('route' => 'admin_default', 'module' => 'ynresume', 'controller' => 'faqs', 'action' => 'edit', 'id' => $item->faq_id),
                    $this->translate('edit')
                )?>
                |
                <?php echo $this->htmlLink(
                    array('route' => 'admin_default', 'module' => 'ynresume', 'controller' => 'faqs', 'action' => 'delete', 'id' => $item->faq_id),
