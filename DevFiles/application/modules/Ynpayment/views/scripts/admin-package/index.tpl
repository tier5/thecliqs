...
<?php
  ...
  if( $settings->getSetting('user.support.links', 0) == 1 ) {
    echo 'More info: <a href="http://support.socialengine.com/questions/177/Admin-Panel-Billing-Plans" target="_blank">See KB article</a>.';	
  } 
?>	
      ...
      <?php foreach( $this->paginator as $item ): ?>
        <tr>
          ...
          <td class='admin_table_centered'>
            <?php if( $item->level_id ): ?>
              <?php if( ($level = Engine_Api::_()->getItem('authorization_level', $item->level_id)) ): ?>
                <a href='<?php echo $this->url(array('module' => 'authorization','controller' => 'level', 'action' => 'edit', 'id' => $item->level_id), 'admin_default', true) ?>'>
          ...
          <td class='admin_table_options'>
            ...
            |
            <a href='<?php echo $this->url(array('package_id' => $item->package_id), 'ynpayment_admin_subscription', true);?>'>
