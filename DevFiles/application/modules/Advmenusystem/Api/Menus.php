...
{
	public function getNavigation($name, array $options = array(), $activeItem = null, $type = '')
	{
		$pages = $this -> getMenuParams($name, $options, $activeItem, $type);
		$navigation = new Zend_Navigation();
		$navigation -> addPages($pages);
		return $navigation;
	}

	public function getMenuParams($name, array $options = array(), $activeItem = null, $type = '')
	{
