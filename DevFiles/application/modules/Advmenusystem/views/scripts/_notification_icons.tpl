...
<div id="ynadvmenu_MessagesUpdates" class="ynadvmenu_mini_wrapper" title="<?php echo $this->translate("Messages") ?>">
    <a style:  href="javascript:void(0);" <?php if($this -> design_type == 'icon') :?> class="ynadvmenu_NotifiIcon" <?php endif;?> id="ynadvmenu_messages" >
        <?php if($this -> design_type == 'title') :?>
            <div id='title-mini-message' class="title-mini" style="<?php if($this->title_color) echo "color:#{$this->title_color}"?>"><?php echo $this->translate("Messages") ?></div>
        <?php endif;?>
...
<div id="ynadvmenu_FriendsRequestUpdates" class="ynadvmenu_mini_wrapper" title="<?php echo $this->translate("Friend Requests") ?>">
    <a href="javascript:void(0);" <?php if($this -> design_type == 'icon') :?> class="ynadvmenu_NotifiIcon" <?php endif;?> id = "ynadvmenu_friends">
        <?php if($this -> design_type == 'title') :?>
            <div id='title-mini-friend' class="title-mini" style="<?php if($this->title_color) echo "color:#{$this->title_color}" ?>"><?php echo $this->translate("Friend Requests") ?></div>
        <?php endif;?>
...
<div id="ynadvmenu_NotificationsUpdates"  class="ynadvmenu_mini_wrapper" title="<?php echo $this->translate("Notifications") ?>">
    <a href="javascript:void(0);" <?php if($this -> design_type == 'icon') :?> class="ynadvmenu_NotifiIcon" <?php endif;?> id = "ynadvmenu_updates">
        <?php if($this -> design_type == 'title') :?>
            <div id='title-mini-notification' class="title-mini" style="<?php if($this->title_color) echo "color:#{$this->title_color}" ?>"><?php echo $this->translate("Notifications") ?></div>
        <?php endif;?>
