...
<script type="text/javascript">    
    en4.core.runonce.add(function(){
        <?php if (!$this->renderOne): ?>
            ...
            $('ynultimatevideo_videos_previous').style.display = '<?php echo $this->paginator->getCurrentPageNumber() == 1 ? 'none' : ''; ?>';
            $('ynultimatevideo_videos_next').style.display = '<?php echo ( $this->paginator->count() == $this->paginator->getCurrentPageNumber() ? 'none' : '' ) ?>';
