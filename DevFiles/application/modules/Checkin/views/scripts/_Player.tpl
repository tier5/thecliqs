 ...
 * @version    $Id: _Player.tpl 9330 2011-09-27 23:33:35Z john $
 * @author     Steve
 */
?>
<?php
  ...
  en4.core.runonce.add(function() {
    if( !$type(soundManager) || !$type(en4.music) ) {
      Asset.javascript('<?php echo $this->layout()->staticBaseUrl . 'externals/soundmanager/script/soundmanager2'
           . (APPLICATION_ENV == 'production' ? '-nodebug-jsmin' : '' ) . '.js' ?>');
      Asset.javascript('<?php echo $this->layout()->staticBaseUrl . 'application/modules/Music/externals/scripts/core.js' ?>');
      Asset.javascript('<?php echo $this->layout()->staticBaseUrl . 'application/modules/Music/externals/scripts/player.js' ?>');
    }
...
<div class="music_player_wrapper" id="music_player_<?php echo $random ?>">
    ...
    <div class="music_player" <?php if (isset($this->id)) echo "id='{$this->id}'" ?> <?php if ($this->short_player): ?>style="display:none;"<?php endif; ?>>
      <div class="music_player_top">
        <div class="music_player_art" style="display: none;">
        ...
        <div class="music_player_info">
          <div class="music_player_controls_wrapper">
            ...
            <div class="music_player_controls_left">
              <span class="music_player_button_prev" style="display: none;"></span>
              <span class="music_player_button_play"></span>
              <span class="music_player_button_next" style="display: none;"></span>
            ...
            <div class="music_player_controls_wrapper">
              <div class="music_player_controls_left">
                ...
                <div class="playlist_short_player_title">
                  <?php if (!empty($songs) && !empty($songs[0])) echo $this->string()->truncate($songs[0]->getTitle(), 20, '...') ?>
                </div>
    ...
    <div class="music_playlist_stats" style="display: none">
