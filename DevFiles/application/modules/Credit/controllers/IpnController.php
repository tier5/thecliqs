 ...
 * @version    $Id: IpnController.php 2012-01-23 17:22:12 taalay $
 * @author     Taalay
 */
...
class Credit_IpnController extends Core_Controller_Action_Standard
{
  public function __call($method, array $arguments)
  {
    ...
    // Log ipn
    $ipnLogFile = APPLICATION_PATH . '/temporary/log/credit-payment-ipn.log';
    ...
    $gatewayPlugin = $gateway->getPlugin();
		...
		$str = str_replace('Payment', 'Credit', get_class($gatewayPlugin));
