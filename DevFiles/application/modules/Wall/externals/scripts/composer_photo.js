...
Wall.Composer.Plugin.Photo = new Class({
  ...
  activate : function() {
    ...
    this.elements.form = new Element('form', {
      'class' : 'wall-compose-form wall-compose-photo-form',
      'method' : 'post',
      'action' : fullUrl,
    ...
    if( this.options.fancyUploadEnabled && this.options.fancyUploadOptions ) {
      ...
      this.elements.formFancyFile = new Element('a', {
        ...
        'class' : 'buttonlink wall-compose-photo-form-fancy-file',
...
'<div style="display:none;">\n\
  ...
  <div class="current-text"></div>\n\
      ...
      try {
        ...
        if( $type(console) ) alert(e);
      }

      this.elements.camera = new Element('a', {
        'href' : 'javascript:void(0);',
        'class' : 'buttonlink wall-compose-photo-form-camera',
        'html' : en4.core.language.translate('WALL_COMPOSE_CAMERA'),
        'events': {
          click: function (){
