...
<h3><?php echo $this->translate('Most Commented Quizzes'); ?></h3>
...
<li class="he_quiz_block">
  ...
  <div class="he_quiz_info">
    ...
    <div class="he_quiz_misc">
        <?php echo $this->translate(array('quiz_<b>%s</b> comment', '<b>%s</b> comments', $quiz->comment_count), '<span class="he_quiz_misc_important">' . $quiz->comment_count . '</span>') ?>
    </div>
  </div>
</li>
<?php endforeach; ?>
