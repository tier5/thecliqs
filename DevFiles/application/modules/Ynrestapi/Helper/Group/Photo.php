...
class Ynrestapi_Helper_Group_Photo extends Ynrestapi_Helper_Base
{
    ...
    public function field_group()
    {
        ...
        $groupFields[] = 'total_photo';

        $group = $this->_getGroup();
        $this->data['group'] = Ynrestapi_Helper_Meta::exportOne($group, $groupFields);
    }
