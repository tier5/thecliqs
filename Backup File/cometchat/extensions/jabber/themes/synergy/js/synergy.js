        ...
        jqcc.synergy, {
            ...
            getRecentDataAjaxSuccess:  function(data , id , originalid) {
                ...
                $.each(data, function(id, message) {
                    ...
                    temp += ($[ccjabber.theme].processMessage('<div class="cometchat_messagebox">'+fromavatar+sentdata+'<div class="cometchat_chatboxmessage'+selfstyle+'" id="cometchat_message_' + message.time + '"><div class="cometchat_messagearrow"></div><span class="cometchat_chatboxmessagecontent">'+message.msg+'</span></div></div>', selfstyle));
                });
                if (temp != '') {
