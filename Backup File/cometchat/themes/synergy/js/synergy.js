                ...
                if(typeof document.body.style.maxHeight==="undefined"){
					...
					if('<?php echo $p_; ?>'<3){
                        ...
                        if(iOSmobileDevice && window.top != window.self){
                            mobileOverlay = '<div class="cometchat_mobile_overlay"><p>'+language[110]+' <a class="cometchat_openmobiletab" href="javascript:void(0);">'+language[111]+'</a>'+language[112]+'</p></div>';
                            $('#cometchat').html(mobileOverlay);
                            jqcc.cometchat.setThemeVariable('runHeartbeat', 0);
                        }
                    }
            ...
            if(settings.enableType!=1 && embeddedchatroomid==0){
                ...
                if(typeof(cometchat_user_popup)=='undefined' || cometchat_user_popup.length<1){
                    ...
                    cometchat_user_popup.find('div.cometchat_user_closebox').click(function(){
                        ...
                        if(jqcc.isEmptyObject(chatBoxesOrder)&&$.cookie(settings.cookiePrefix+'crstate')!=null&&$.cookie(settings.cookiePrefix+'crstate')!='' && Object.keys(chatroomData).length > 0 && hasChatroom== 1){
