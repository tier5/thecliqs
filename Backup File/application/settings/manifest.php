...
return array(
  ...
  'package' => array(
    ...
    'changeLog' => array(
      '4.8.11' => array(
        'application/settings/manifest.php' => 'Incremented version and Updated text for APCu Extension',
        'application/widgets/weather' => 'Removed weather widget due to unavilibility of wunderground.com API\'s free tier',
      ),
      '4.8.10' => array(
        'application/settings/manifest.php' => 'Incremented version and added a check for exif extension, which is required for correct rotation of photos uploaded via mobile devices to the list of recommended PHP extensions',
      ),
      '4.8.9' => array(
