<?php
class Yncredit_IpnController extends Core_Controller_Action_Standard
{
  public function __call($method, array $arguments)
  {
    ...
    // Log ipn
    $ipnLogFile = APPLICATION_PATH . '/temporary/log/yncredit-payment-ipn.log';
    ...
    $gatewayPlugin = $gateway->getPlugin();
		...
		$str = str_replace('Payment', 'Yncredit', get_class($gatewayPlugin));
