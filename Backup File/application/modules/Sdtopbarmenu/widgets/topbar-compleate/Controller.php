<?php
class Sdtopbarmenu_Widget_TopbarCompleateController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
	...
	$this->view->navigation = $navigation = $this->getNavigation('core_main');
