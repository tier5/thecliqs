...
class Headvancedalbum_Form_Album extends Engine_Form
{
  public function init()
  {
    ...
    // Displays Quick / Advanced
    $content = '<a href="javascript:void(0);" id="headv_quick">'.$view->translate('HEADVANCEDALBUM_Quick').'</a>'
      . '&nbsp;/&nbsp;'
      . '<a href="javascript:void(0);" id="headv_advanced">'.$view->translate('HEADVANCEDALBUM_Advanced').'</a>';

    $this->addElement('Dummy', 'options', array(
      'content' => $content
    ));
