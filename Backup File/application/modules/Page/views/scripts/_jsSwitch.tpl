...
//            console.log(option_id, $$('.parent_'+field_id));
    ...
    //console.log(childElement);
                ...
                if (childElement.type == 'radio' || childElement.type == 'checkbox') {
                    childParentContainer = childElement.getParent('li').getParent('li');
                }

                var childContainer;
                if( childElement.getParent('form').getProperty('class') == 'field_search_criteria' ) {
                ...
                var childOptions = childElement.getProperty('class').match(/option_([\d]+)/gi);
                ...
                if( force == 'hide' && !option_id.contains(childOptionId)) {
                    if( !childElement.hasClass('field_toggle_nohide') ) {
                        ...
                        if (childParentContainer) {childParentContainer.setStyle('display', 'none');}
                    ...
                    if (childParentContainer) {childParentContainer.setStyle('display', '');}
                    nextForce = force;
