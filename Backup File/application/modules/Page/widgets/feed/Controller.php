...
class Page_Widget_FeedController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $this->view->baseUrl = $subject->getHref();
    ...
    $this->view->show_activity_feed = (int) $request->getParam('action_id');
