...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Remove the selected Creators?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to remove %d Creators?", $this->count) ?>
      </p>
      <br />
      <p>
  ...
  <form>
    <div>
      <h3><?php echo $this->translate("Remove the selected Creators?") ?></h3>
      <p>
        <?php echo $this->translate("Please select at least one Creator to remove.") ?>
      </p>
      <br/>
