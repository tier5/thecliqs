<div class="form-wrapper">
	...
	<div id="form_<?php echo $this -> field -> field_id;?>-element" class="form-element">
		<div>
			...
			&emsp;&emsp;&emsp;&emsp;<a type="button" class="smoothbox fa fa-pencil" href="<?php echo  $this -> edit_href;?>"></a>
			&nbsp;&nbsp;<a type="button" class="smoothbox fa fa-minus" href="<?php echo  $this -> delete_href;?>"></a>
		</div>
		<div>
