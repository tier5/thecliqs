...
class Wall_Form_Service_Linkedin extends Wall_Form_Subform
{
  ...
  public function init()
  {
    ...
    $this->addElement('Checkbox', 'enabled', array(
      ...
      'onclick' => '$$("#consumerkey-wrapper, #consumersecret-wrapper").set("style", "opacity:" + (this.checked) ? 1 : 0.7);$$("#consumerkey-wrapper input, #consumersecret-wrapper input").set("disabled", !this.checked);'
    ));
