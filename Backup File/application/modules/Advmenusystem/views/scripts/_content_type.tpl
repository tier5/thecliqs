<ul class="content">
	<?php foreach ($this->contents as $content):?>
		<?php 
			...
			$title = $this -> translate((isset($params['title']) && $params['title'] != '') ? $params['title'] : $this->translate("Untitled"));
			$photoUrl = ($content->photo_id) ? $content->getPhotoUrl() : "";
		?>
		<li class="item-content">
			<a href="<?php echo $url;?>" title="<?php echo $this -> translate($title);?>" style="background-image: url(<?php echo $photoUrl;?>);"
