	...
	choiceSelect: function(choice) {
		...
		if( !this.options.alwaysOpen ) {
                ...
                if (this.options.autocompleteType=='message') {
                  ...
                  {
                  	this.doAddValueToHidden(choice.id, token.id, 'toValues', true, null);
                  }
                }
        ...
        doPushSpan: function(name, toID, newItem, hideLoc, list){
          ...
          if (newItem){
            ...
            myElement.innerHTML = "<a target='_blank' href=''>"+name+"</a>"+" <a href='javascript:void(0);' onclick='this.parentNode.destroy();removeFromToValue(\""+toID+"\", \""+hideLoc+"\");'><i class='fa fa-times'></i></a>";
          }
          else{
            myElement.id = "tospan_"+name+"_"+toID;
            myElement.innerHTML = "<a target='_blank' href=''>"+name+"</a>"+" <a href='javascript:void(0);' onclick='this.parentNode.destroy();removeFromToValue(\""+toID+"\", \""+hideLoc+"\");'><i class='fa fa-times'></i></a>";
