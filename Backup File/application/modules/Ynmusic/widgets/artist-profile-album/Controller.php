<?php
class Ynmusic_Widget_ArtistProfileAlbumController extends Engine_Content_Widget_Abstract {
	...
	public function indexAction() {
		...
		$paginator = Engine_Api::_()->getDbTable('albums', 'ynmusic')->getAlbumsPaginator(array('artist_id' => $subject->getIdentity()));
