<div id="ynmusic_listing_song_<?php echo $this->identity;?>" class="music-listing">
    <div class="ynmusic-block-count-mode-view <?php if (empty($this->mode_enabled)) echo 'not-mode-view'?>">
    	<div id="ynmusic-total-item-count"><?php echo $this->translate(array('ynmusic_song_count_num_ucf_span', '%s <span>Songs</span>', $this->paginator->getTotalItemCount()), $this->paginator->getTotalItemCount())?></div>
