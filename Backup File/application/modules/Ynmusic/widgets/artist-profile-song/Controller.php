<?php
class Ynmusic_Widget_ArtistProfileSongController extends Engine_Content_Widget_Abstract {
	...
	public function indexAction() {
		...
		$paginator = Engine_Api::_()->getDbTable('songs', 'ynmusic')->getSongsPaginator(array('artist_id'=> $subject->getIdentity()));

		$paginator->setCurrentPageNumber($page);
		$paginator->setItemCountPerPage(Engine_Api::_()->getApi('settings', 'core')->getSetting('ynmusic_songsPerPage', 10));	
