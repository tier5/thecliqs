<?php
class Ynmusic_Widget_UserProfilePlaylistsController extends Engine_Content_Widget_Abstract {
	...
	public function indexAction() {
		...
		$paginator = Engine_Api::_()->getDbTable('playlists', 'ynmusic')->getPaginator(array('user_id'=>$subject->getIdentity()));
