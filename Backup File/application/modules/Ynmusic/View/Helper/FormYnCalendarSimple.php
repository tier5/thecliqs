 ...
 * @license    http://www.socialengine.net/license/
 */
class Ynmusic_View_Helper_FormYnCalendarSimple extends Zend_View_Helper_FormElement
{
    ...
    public function formYnCalendarSimple($name, $value = null, $attribs = null, $options = null, $listsep = "<br />\n")
    {
        ...
        if (!self::$_loaded)
        {
            $this->view->headScript()->appendFile($baseUrl . '/application/modules/Ynmusic/externals/scripts/yncalendar.js');
            self::$_loaded = true;
        }
        ...
        return '<div class="ynmusic_calendar_container" style="display:inline">' . $this -> view -> formText($name, @$value, array_merge(array(
            'class' => 'calendar-date',
            'id' => $dateId,
            'style' => 'width:120px'
