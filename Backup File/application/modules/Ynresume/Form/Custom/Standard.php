...
class Ynresume_Form_Custom_Standard extends Engine_Form
{
  /* Custom */
  ...
  public function getFieldStructure()
  {
    ...
    return Engine_Api::_()->getApi('fields','ynresume')->getFieldsStructureFullHeading($this->getItem(), $this ->_heading, $this->_topLevelId, $this->_topLevelValue);
  }
...
//        }
        ...
        $valueRow->value = $value = htmlspecialchars($value);
        if( $this->_hasPrivacy && 
            !empty($this->_privacyValues[$key]) &&
            !empty($privacyOptions[$this->_privacyValues[$key]]) ) {
