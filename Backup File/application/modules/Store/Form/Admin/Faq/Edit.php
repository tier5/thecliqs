 ...
 * @version    Id: Edit.php 27.04.12 18:30 TeaJay $
 * @author     Taalay
 */
...
class Store_Form_Admin_Faq_Edit extends Engine_Form
{
  public function init()
  {
    $this
      ->setTitle('STORE_Edit FAQ.')
      ->setDescription('STORE_ADMIN_FAQ_EDIT_DESCRIPTION')
