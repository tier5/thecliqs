<?php class Ynsocialads_Bootstrap extends Engine_Application_Bootstrap_Abstract
{
...
public function _initynsocialads1407728177()
{
...
else
{
    ...
    {
        $res = @mysql_query("INSERT IGNORE INTO `engine4_younetcore_license` (`name`, `title`, `descriptions`, `type`, `current_version`, `lasted_version`, `is_active`, `date_active`, `params`, `download_link`, `demo_link`) VALUES ('ynsocialads', 'Social Ads', '', 'module', '4.01p2', '4.01p2', '1', NULL, NULL, NULL, NULL);",$connection);
        $this->e($module_name,1);
    }
    else
    {
        $res = @mysql_query("Update `engine4_younetcore_license` set `lasted_version` = '4.01p2' , `current_version` = '4.01p2' where `name`='ynsocialads' ");
