 ...
 */
class Ynultimatevideo_Plugin_Adapter_Youtube extends Ynultimatevideo_Plugin_Adapter_Abstract {
    ...
    public function isValid() {
        ...
        if ($code) {
            $api_key = Engine_Api::_()->getApi('settings', 'core')->getSetting('ynultimatevideo.youtube.apikey', 'AIzaSyDpUPT_nafV_MFSAlc-8AH4e1Gy578iK0M');
