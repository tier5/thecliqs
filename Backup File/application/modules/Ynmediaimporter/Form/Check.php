...
class Ynmediaimporter_Form_Check extends Engine_Form
{
    public function init()
    {
        ...
        $this 
         ...
         -> getRouter() -> assemble(array('controller'=>'import','action'=>'select-album','format'=>'smoothbox'),'ynmediaimporter_extended',1));
        
        $translator = $this->getTranslator();
        $message =  $translator->translate('Checking your request ...');
    
        $this->addElement('Dummy','message_stage',array('content'=>'<div id="message_stage"><div class="ynmediaimporter_loading_image"></div><center>'.$message.'</center></div>','decorators'=>array('ViewHelper')));
        ...
        // Submit or succumb!
        $this -> addElement('Button', '_continue', array(
            'label' => 'Continue',
            'type' => 'submit',
