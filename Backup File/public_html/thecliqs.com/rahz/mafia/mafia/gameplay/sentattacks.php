...
<?
#start pagination
$rows = $db1->createRecordset("SELECT id,src,dest,msg,time,del,crew FROM $tab[mail] WHERE src='$id' AND inbox='attacks' ORDER BY time DESC");
          ...
          <table width="98%" height="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#FFFFFF">
           <tr bgcolor="">
            <td bgcolor="#cccccc">
             ...
             <tr bgcolor="#cccccc">
              <td align="left" valign="middle" bgcolor="#cccccc"><font size="2"><b><font color="#FF0000">attacking</font></b> 
                  <?if($crw[1]){?>
              ...
              <td align="right" valign="middle" bgcolor="#cccccc"><font size="2"><b><a href="out.php?pid=<?=$pmp[0]?>&tru=<?=$tru?>&camefrom=sentattacks.php?tru=<?=$tru?>">send message</a></b></font></td>
             </tr>
            </table>            </td>
           </tr>
           <tr>
            <td bgcolor="#cccccc" ><font color="#000000" size="2"><?=$sole[3]?></font></td>
           </tr>
      </table>
          <br>
          <br>
