...
$user_link = '<a href="'.$user_url.'" class="feed_item_username">'.$user_name.'</a>';
...
if ($update_type == 'ANSW'){
  ...
  $body = $this->translate('WALL_LINKEDIN_%1$s answered: %2$s', array($user_link, '<a href="'.$second_link.'" class="feed_item_username">'.$second_name.'</a>'));
...
/* CONN */
  ...
  $body = $this->translate('WALL_LINKEDIN_%1$s is now connected to %2$s.', array($user_link, '<a href="'.$second_link.'" class="feed_item_username">' . $second_name . '</a>'));
...
/* JGRP */
  ...
  $body = $this->translate('WALL_LINKEDIN_%1$s joined the group %2$s.', array($user_link, '<a href="'.$second_link.'" class="feed_item_username">'.$second_name.'</a>'));
...
/* RECU */
  ...
  if (empty($action['updateContent']['person']['recommendationsGiven'])){
    ...
    $body = $this->translate('WALL_LINKEDIN_%1$s was recommended %2$s', array($user_link,  '<a href="'.$second_link.'" class="feed_item_username">'.$second_name.'</a>'));
    ...
    $body = $this->translate('WALL_LINKEDIN_%1$s recommends %2$s', array($user_link,  '<a href="'.$second_link.'" class="feed_item_username">'.$second_name.'</a>'));
...
/* QSTN */
  ...
  $share_content = '
    ...
    <div class="attachment">
      <div class="media">
        '.( (!empty($action['updateContent']['person']['pictureUrl'])) ? '<div class="media_photo"><a href="'.@$action['updateContent']['person']['currentShare']['content']['submittedUrl'].'"><img src="'.@$action['updateContent']['person']['currentShare']['content']['thumbnailUrl'].'" /></a></div>' : '' ).'
  ...
  $body = $this->translate('WALL_LINKEDIN_%1$s is now following %2$s.', array($user_link, '<a href="'.$second_link.'" class="feed_item_username">'.$second_name.'</a>'));
