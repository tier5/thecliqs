...
?>
  <?php echo $this->htmlLink($this->url(array('action'=>'user-auction','user_id' => Engine_Api::_()->core()->getSubject()->getIdentity()), 'ynauction_general'), $this->translate('View All Auctions'), array('class' => 'buttonlink icon_ynauction_viewall')) ?>
<?php endif;?>