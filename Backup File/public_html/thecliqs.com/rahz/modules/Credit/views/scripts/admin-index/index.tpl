 ...
 * @version    $Id: index.tpl  03.01.12 13:36 TeaJay $
 * @author     Taalay
 */
?>
...
<p>
  <?php echo $this->translate("CREDIT_VIEWS_SCRIPTS_ADMININDEX_INDEX_DESCRIPTION") ?>
</p>
...
<form id='multimodify_form' method="post" action="<?php echo $this->url(array('action'=>'multi-modify'));?>" onSubmit="multiModify()">
  <table class='admin_table'>
    <thead>
      <tr>
        <th style='width: 1%;'><a href="javascript:void(0);" onclick="javascript:changeOrder('log_id', 'DESC');"><?php echo $this->translate("ID") ?></a></th>
