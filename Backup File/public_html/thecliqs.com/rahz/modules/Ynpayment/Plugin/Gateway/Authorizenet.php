 ...
 * @author MinhNC
 */
class Ynpayment_Plugin_Gateway_Authorizenet extends Engine_Payment_Plugin_Abstract 
{
	...
	public function getOrderDetailLink($orderId) {
		...
		if ($this -> getGateway() -> getTestMode()) {
			...
			return 'https://sandbox.authorize.net/';
		} else {
			return 'https://account.authorize.net/';
		}
	}
	...
	public function getAdminGatewayForm() {
		return new Ynpayment_Form_Admin_Gateway_Authorizenet();
	}
