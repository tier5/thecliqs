 ...
 * @author MinhNC
 */
class Ynpayment_Plugin_Gateway_ITransact extends Engine_Payment_Plugin_Abstract 
{
	...
	public function getOrderDetailLink($orderId) 
	{
		...
		return 'https://secure.paymentclearing.com/g/cp/main';
	}
	...
	public function getAdminGatewayForm() {
		return new Ynpayment_Form_Admin_Gateway_ITransact();
	}
