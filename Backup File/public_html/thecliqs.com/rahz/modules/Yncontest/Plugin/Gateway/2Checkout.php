<?php
class Yncontest_Plugin_Gateway_2Checkout extends Payment_Plugin_Gateway_2Checkout
{
  ...
  public function onPackageTransactionReturn(Yncontest_Model_Order $order, array $params = array())
  {
    ...
    $order->save();
     ...
     $db->beginTransaction();
     try {
		Engine_Api::_() -> yncontest() -> processContest($order -> security_code,  $params['order_number']);		 
      $db->commit();
    } catch (Exception $e) {
      $db->rollBack();
      throw $e;
