...
<?php else: ?>
    ...
    <div id="yncontest_direction" class="global_form_popup">
        <h4><?php echo $this->translate("Get Direction");?></h4>
        <div class="yncontest_widget_location_direction_location">
            ...
            <span class="close-btn" id="yncontest_location_direction_close_btn">x</span>
        </div>
        <div class="yncontest_widget_location_direction_get_current_position">
            <a href="javascript:void(0);" onclick="getMyPosition()" class="buttonlink"><?php echo $this->translate("Get current position");?></a>
        </div>

        <div class="yncontest_widget_location_destination">
            <label for="destination"><?php echo $this->translate("Destination");?></label>
            <div><i class="fa fa-map-marker" aria-hidden="true"></i>
            <span><?php echo $this->contest->location;?></span></div>
        </div>
        <div class="yncontest_widget_location_direction yncontest_widget_location_direction_button">
            <label>&nbsp;</label>
    ...
    <script type="text/javascript">
        var fromPoint;
        var endPoint = new  google.maps.LatLng(<?php echo $this->contest->latitude;?>, <?php echo $this->contest->longitude;?>);
        ...
        {
            $('yncontest_location_direction_close_btn').addEvent('click', function(e) {
                $('pac-input').set('value','');
                fromPoint = null;
            });
        });
