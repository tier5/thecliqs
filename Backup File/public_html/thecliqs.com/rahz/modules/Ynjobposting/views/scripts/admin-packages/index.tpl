<script type="text/javascript">
	...
	function multiSelected(action){
	    ...
	    $('multiselect').action = en4.core.baseUrl +'admin/ynjobposting/packages/multiselected';
...
array('route' => 'admin_default', 'module' => 'ynjobposting', 'controller' => 'packages', 'action' => 'create'),
	...
	<table style="position: relative; width: 100%" class='admin_table'>
	  <thead>
	    <tr>
	      ...
	      <th><a href="javascript:void(0);" onclick="javascript:changeOrder('package_id', 'ASC');"><?php echo $this->translate('ID') ?></a></th>
	      ...
	      <th><a href="javascript:void(0);" onclick="javascript:changeOrder('valid_period', 'ASC');"><?php echo $this->translate('Valid Period') ?></a></th>
