<?php
class Ynultimatevideo_Form_Admin_Migration_ReportFilter extends Engine_Form {
    public function init() {
		...
		$this->addElement('Select', 'type', array(
            ...
            'multiOptions' => array(
				'all' => 'all',
				'ynultimatevideo_video' => 'video_import_type',
				'ynultimatevideo_playlist' => 'playlist_import_type',
			),
            'value' => 'all',
        ));
