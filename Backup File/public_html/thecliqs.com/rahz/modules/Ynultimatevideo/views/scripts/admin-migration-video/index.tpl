...
<ul class="item-tab">
	<li id="item-tab-video" class="active"><a href="<?php echo $this->url(array('module'=>'ynultimatevideo','controller'=>'migration-video'), 'admin_default', true)?>"><?php echo $this->translate('Videos')?></a></li>
	<li id="item-tab-playlist"><a href="<?php echo $this->url(array('module'=>'ynultimatevideo','controller'=>'migration-video','action'=>'playlist'), 'admin_default', true)?>"><?php echo $this->translate('Playlists')?></a></li>
</ul>
    ...
    <table class='admin_table'>
        <thead>
            <tr>
                ...
                <th><a href="javascript:void(0);" onclick="javascript:changeOrder('object.title', 'ASC');"><?php echo $this->translate("Video") ?></a></th>
...
<?php else: ?>
<div class="tip">
    <span><?php echo $this->translate("There are no videos can import.") ?></span>
</div>
<?php endif; ?>
