...
class Ynprofilestyler_Form_Custom_MenuBar extends Engine_Form
{
	public function init()
	{
		...
		$this->addElement('select', 'background_image', array(
			'label' => 'Use Images',
		    'attribs' => array('id' => 'menubar_background_image')
		));
		
		$this->addElement('hidden', 'background_repeat');
			...
			'decorators'                  => array(
				array(
					array('data' => new Ynprofilestyler_Form_Decorator_Div(
						array('tag' => 'div', 'class' => 'text-color'))),
				),
				array('HtmlTag', array(
					'tag' => 'dd',
				)),
