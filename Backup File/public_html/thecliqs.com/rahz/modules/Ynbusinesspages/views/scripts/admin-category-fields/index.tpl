...
<div class="admin_fields_type">
  <p><?php echo $this->translate("YNBUSINESSPAGES_ADMIN_CATEGORY_FIELD_DESCRIPTION") ?></p>
  <br />
...
<div class="admin_fields_options">
  <?php echo $this->htmlLink(array(
	    ...
	    'controller' => 'category'
  ), $this->translate('Back to Manage Categories'), array('class'=>'buttonlink ynbusinesspages_icon_back')) ?>
