...
<div id="ynbusinesspages_direction">
<h4><?php echo $this->translate("Get Direction");?></h4>
<div class="ynbusinesspages_widget_location_direction">
    ...
    <span class="close-btn" id="ynbusinesspages_location_direction_close_btn">x</span>
</div>
<div class="ynbusinesspages_widget_location_direction get_current_position">
...
<div class="ynbusinesspages_widget_location_direction ynbusinesspages_widget_location_destination">
  ...
  <div style="overflow: hidden">
	   ...
	   <div class="location" style="display: inline;"><?php echo $this->item->location;?></div>
  </div>
</div>
<div class="ynbusinesspages_widget_location_direction ynbusinesspages_widget_location_direction_button">
    <label>&nbsp;</label>
...
{
	$('ynbusinesspages_location_direction_close_btn').addEvent('click', function(e) {
		$('pac-input').set('value','');
		fromPoint = null;
    });
});
