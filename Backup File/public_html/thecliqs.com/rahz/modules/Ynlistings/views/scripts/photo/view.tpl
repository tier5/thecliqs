...
<div class='ynlistings_photo_view'>
  <div class="ynlistings_photo_nav">
    <div>
  ...
  <div class='ynlistings_photo_info'>
    <div class='ynlistings_photo_container' id='media_photo_div'>
    ...
    <?php if( $this->photo->getTitle() ): ?>
      <div class="ynlistings_photo_title">
        <?php echo $this->photo->getTitle(); ?>
      </div>
    <?php endif; ?>
    <?php if( $this->photo->getDescription() ): ?>
      <div class="ynlistings_photo_description">
        <?php echo $this->photo->getDescription() ?>
      </div>
    <?php endif; ?>
    <div class="ynlistings_photo_owner">
      <?php echo $this->translate('By');?> <?php echo $this->htmlLink($this->photo->getOwner()->getHref(), $this->photo->getOwner()->getTitle()) ?>
    </div>
    <div class="ynlistings_photo_tags" id="media_tags" class="tag_list" style="display: none;">
      <?php echo $this->translate('Tagged:');?>
    </div>
    <div class="ynlistings_photo_date">
      <?php echo $this->translate('Added');?> <?php echo $this->timestamp($this->photo->creation_date) ?>
      <?php if($this -> viewer -> getIdentity()):?>
	      <?php if( $this->canEdit ): ?>
	        - <?php echo $this->htmlLink(array('route' => 'ynlistings_extended', 'controller' => 'photo', 'action' => 'edit', 'photo_id' => $this->photo->getIdentity(), 'format' => 'smoothbox'), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
	        - <?php echo $this->htmlLink(array('route' => 'ynlistings_extended', 'controller' => 'photo', 'action' => 'delete', 'photo_id' => $this->photo->getIdentity(), 'format' => 'smoothbox'), $this->translate('Delete'), array('class' => 'smoothbox')) ?>
	      <?php endif; ?>
