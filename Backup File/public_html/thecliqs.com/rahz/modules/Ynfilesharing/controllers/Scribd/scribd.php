...
class Scribd {
	 ...
	 * @return array containing doc_id, access_key, and secret_password if
	 *         nessesary.
	 */
	 ...
	 *
	 * @return array containing doc_id, title, description, access_key, and
	 *         conversion_status for all documents
	 */
	 ...
	 * @param int $doc_id
	 *        	: document id
	 * @return string containing DISPLAYABLE", "DONE", "ERROR", or "PROCESSING"
	 ...
	 *
	 * @return array containing doc_id, title , description , access, tags,
	 *         show_ads, license, access_key, secret_password
	 */
	 ...
	 *        	: "by", "by-nc", "by-nc-nd", "by-nc-sa", "by-nd", "by-sa", "c"
	 *        	or "pd"
	 * @param string $access
	 *        	: private, or public
	 * @param array $show_ads
	 ...
	 * @return array of results, each of which contain doc_id, secret password,
	 *         access_key, title, and description
	 */
	 ...
	 * @return array containing session_key, name, username, and user_id of the
	 *         user;
	 */
