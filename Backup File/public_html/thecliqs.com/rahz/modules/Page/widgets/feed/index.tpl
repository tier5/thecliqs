...
$this->headTranslate(array(
  '{actors:$subject:$object} added {var:$count} song(s) to the playlist {var:$link}:'
));
?>
...
<?php if ($this->show_activity_feed) : ?>
  <script type="text/javascript">
    en4.core.runonce.add(function(){
      tabContainerSwitch($$("#global_page_page-index-view .tab_layout_page_feed a")[0], 'generic_layout_container layout_page_feed');
    });
  </script>
  <div class="feed_viewmore" style="font-weight: bold;"><?php echo $this->htmlLink($this->baseUrl, $this->translate('View More Activities') ); ?></div>
<?php endif; ?>
