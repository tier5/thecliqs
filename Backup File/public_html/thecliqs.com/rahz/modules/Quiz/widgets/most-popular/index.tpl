...
<h3><?php echo $this->translate('Most Popular Quizzes'); ?></h3>
...
<li class="he_quiz_block">
  ...
  <div class="he_quiz_info">
    ...
    <div class="he_quiz_misc">
     <?php echo $this->translate(array('quiz_<b>%s</b> view', '<b>%s</b> views', $quiz->view_count), '<span class="he_quiz_misc_important">' . $quiz->view_count . '</span>') ?>
    </div>
  </div>
</li>
<?php endforeach; ?>
