...
class Engine_View_Helper_TinyMceYN extends Zend_View_Helper_Abstract
{
  ...
  protected $_supported = array(
    ...
    'plugins' => array(
      ...
      'nonbreakfing', 'xhtmlxtras', 'imagemanager', 'filemanager', 'template', 'inlinepopups'
    ),
  );
  protected $_config = array(
    'mode' => 'textareas',
    'plugins' => array(
      'emotions', 'table', 'fullscreen', 'media', 'preview', 'paste', 'inlinepopups'
        
    ),
    'theme' => 'advanced',
    'theme_advanced_buttons1' => array(
      'emotions','undo', 'redo', 'cleanup', 'removeformat', 'pasteword', '|', 'code',
      'media', 'image', 'fullscreen', 'preview','hr','visualaid','|','sub','sup','|','charmap'
    ),
      
    'theme_advanced_buttons2' => array('bold','italic','underline','strikethrough','forecolor','backcolor','justifyleft','justifycenter','justifyright','justifyfull','fontselect','fontsizeselect','|','bullist','numlist','|','outdent','indent','blockquote'),
