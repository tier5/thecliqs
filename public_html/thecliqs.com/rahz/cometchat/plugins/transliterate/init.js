 		...
 		return {
 			...
 			init: function (params) {
				...
				if(typeof(params.windowMode) == "undefined") {
 				...
 				if(chatroommode == 1 && jqcc.cometchat.getThemeVariable('mobileDevice') == null) {
 				...
 				}else if(chatroommode == 1 && jqcc.cometchat.getThemeVariable('mobileDevice') != null) {
	 				jqcc.cctransliterate.onLoad({"to":id, "chatroommode": "1", "caller": jqcc.cometchat.getUserID()});
 				} else if(chatroommode == 0 && jqcc.cometchat.getThemeVariable('mobileDevice') == null) {
	 				baseUrl = $.cometchat.getBaseUrl();
	 				baseData = $.cometchat.getBaseData();
