...
<div class="ynlistings_widget_location_direction">
...
<div class="ynlistings_widget_location_direction get_current_position">
...
<div class="ynlistings_widget_location_direction ynlistings_widget_location_destination">
	<label for="destination"><?php echo $this->translate("Destination");?></label>
	<img src="application/modules/Ynlistings/externals/images/location_pin.png" />
	<span><?php echo $this->listing->location;?></span>
</div>
<div class="ynlistings_widget_location_direction ynlistings_widget_location_direction_button">
    <label>&nbsp;</label>
