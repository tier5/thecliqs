...
<?php
  $this->headScript()
    ...
    ->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynlistings/externals/scripts/Autocompleter.js')
	->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynlistings/externals/scripts/Autocompleter.Local.js')
	->appendFile($this->layout()->staticBaseUrl . 'application/modules/Ynlistings/externals/scripts/Autocompleter.Request.js');
?>
