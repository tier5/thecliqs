...
return array(
  '4.8.12' => array(
    ...
    'Form/Compose.php' => 'Fixed log error "Undefined variable: user"',
  ),
  '4.8.7' => array(
    'controllers/MessagesController.php' => 'Fixed log error',
    'Form/Compose.php' => 'Fixed issue with links being appeared broken in messages composed using TinyMCE editor',
    'Model/Conversation.php' => 'Fixed issue with the HTML entities being displayed in encoded form in messages composed using TinyMCE editor',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/messages/inbox.tpl' => 'Fixed an issue with messages where subject in replies was coming as "(No subject)" even when original message had a subject',
    'views/scripts/messages/outbox.tpl' => 'Fixed issue with links being appeared broken in messages composed using TinyMCE editor',
    'views/scripts/messages/search.tpl' => 'Fixed issue with links being appeared broken in messages composed using TinyMCE editor',
    'views/scripts/messages/view.tpl' => 'Fixed issue with links being appeared broken in messages composed using TinyMCE editor',
  ),
  '4.8.5' => array(
    'controllers/MessagesController.php' => 'Added media attachments to messages',
    'Form/Compose.php' => 'Added media attachments to messages',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/messages/upload-photo.tpl' => 'Added media attachments to messages',
    'settings/changelog.php' => 'Incremented version',
  ),
  '4.8.3' => array(
    'views/scripts/messages/compose.tpl' => 'Fixed a bug where autosuggest would only ever suggest friends.',
    'settings/manifest.php' => 'Incremented version',
    'settings/changelog.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.8.1' => array(
    'Api/Core.php' => 'Fixed a bug where some DBs do not treat an empty string as NULL',
    'Model/DbTable/Conversations.php' => 'Fixed a bug where some DBs do not treat an empty string as NULL',
    'settings/manifest.php' => 'Incremented version',
    'settings/changelog.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.8.0' => array(
    'Api/Core.php' => 'Breakage after disabling modules',
    'Model/DbTable/Conversations.php' => 'Breakage after disabling modules',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
  ),
  '4.7.0' => array(
    '/application/languages/en/messages.csv' => 'Added phrases',
    'views/scripts/messages/compose.tpl' => 'Minimized Autocompleter.js',
    'views/scripts/messages/inbox.tpl' => 'Added a missing translation',
    'settings/my.sql' => 'Incremented version',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
  ),
  '4.6.0' => array(
    ...
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'views/scripts/messages/compose.tpl' => 'Fixed incorrect URL for autocomplete javascript',
  ),
  '4.5.0' => array(
