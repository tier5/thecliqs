...
<?php echo $this->render('page-photo/_photos.tpl'); ?>
<?php else: ?>
    ...
    var photos = {
        ...
        load_page:function (page) {
            ...
            new Request.HTML({
                ...
                'url':'<?php echo $this->url(array(
                    ...
                    'type' => $this->type,
                ), 'timeline_page_photo', true); ?>/page/' + page + '/album_id/' + '<?php echo $this->album->getIdentity(); ?>',
                'onRequest':function () {
        ...
        set_photo:function (photo_id) {
            ...
            new Request.JSON({
                ...
                ), 'timeline_page_photo', true); ?>/photo_id/' + photo_id,
                'onRequest':function () {
                    self.he_list.toggleClass('hidden');
                    self.loader.toggleClass('hidden');
                },
        ...
        <div class="options" style="padding-right: 20px">
            <div class="select_btns" style='width: 100%'>
                ...
                <a href="<?php echo $this->url(array(
                    'id' => $this->subject()->getIdentity(),
                    'type' => $this->type,
                ), 'timeline_page_photo', true); ?>" style="float:right;">
