	...
	<div class="form-element">
		<div>
			<label for="playlist_preview_0">
				<img src="<?php echo $this->layout()->staticBaseUrl;?>application/modules/Ynvideochannel/externals/images/playlist_edit_preview_listing.png" />
			</label>
		...
		<div>
			<label for="playlist_preview_1">
				<img src="<?php echo $this->layout()->staticBaseUrl;?>application/modules/Ynvideochannel/externals/images/playlist_edit_preview_slideshow.png" />
			</label>
