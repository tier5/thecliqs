<?php
class Yncontest_AdminMailController extends Core_Controller_Action_Admin
{
	
	public function init(){
		parent::init();
		Zend_Registry::set('admin_active_menu', 'yncontest_admin_main_emailtemplates');
	}
	

  public function templatesAction()
  {
    $this->view->form = $form = new Yncontest_Form_Admin_Mail_Templates();
    ...
    $this->view->templateObject = $templateObject = Engine_Api::_()->getItem('yncontest_mailtemplate', $template);
