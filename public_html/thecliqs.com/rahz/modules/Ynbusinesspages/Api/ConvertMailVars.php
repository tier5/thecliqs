...
class Ynbusinesspages_Api_ConvertMailVars extends Core_Api_Abstract 
{
	...
	public function vars_ynbusinesspages_claim_success($params, $vars) {
		return $params;
	}
	
	public function vars_ynbusinesspages_claim_approved($params, $vars) {
		return $params;
	}
	
	public function vars_ynbusinesspages_business_approved($params, $vars) {
		return $params;
	}
	
	public function vars_ynbusinesspages_business_created($params, $vars) {
		return $params;
	}
	
	public function vars_ynbusinesspages_package_changed($params, $vars) {
		return $params;
	}
}
