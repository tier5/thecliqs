	...
	<div class="ynbusinesspages-profile-header-right">
		<?php if( $this->paginator->getTotalItemCount() > 0 ): ?>
			<?php echo $this->htmlLink(array(
				...
				'tab' => $this->identity,
			), '<i class="fa fa-list"></i>'.$this->translate('View all Social Music Albums'), array(
				'class' => 'buttonlink'
			))
			?>
		<?php endif; ?>
		...
		<?php if ($this->canCreate):?>
			...
			), '<i class="fa fa-plus-square"></i>'.$this->translate('Create Social Music Album'), array(
				'class' => 'buttonlink'
			))
			?>
		<?php endif; ?>
...
<div id="ynmusic_listing_album_<?php echo $this->identity;?>" class="music-listing">
	<div id="ynmusic-listing-content-<?php echo $this ->identity;?>" class="ynmusic-listing-content">
		<?php echo $this->partial('_album-listing.tpl', 'ynmusic', array('paginator' => $this->paginator, 'formValues' => $this->formValues, 'paging' => false, 'ajaxPaging' => true, 'business_id' => $this->subject()->getIdentity()));?>
	</div>
