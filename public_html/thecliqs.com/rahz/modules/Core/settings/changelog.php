...
return array(
  '4.8.12' => array(
    ...
    'Model/Tag.php' => 'Strip tags form tag text',
  ),
  '4.8.11' => array(
    '/application/languages/en/core.csv' => 'Changed phrase in admin panel',
    'externals/styles/admin/main.css' => 'Added style',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'settings/changelog.php' => 'Incremented version',
    'Bootstrap.php' => 'Replaced iconv_set_encoding with ini_set for PHP 5.6 and above to eliminate PHP warnings',
    'settings/content.php' => 'Moved tab container widget admin\'s form to stand-alone form',
    'Controller/Action/Helper/RequireAdmin.php' => 'Used isAllowed method',
    'Form/Admin/Settings/Performance.php' => 'Fixed issue with "Memcache Compression" checkbox field not remaining checked after enabling memcache compression',
    'Form/Admin/Widget/Container.php' => 'Moved tab container widget admin\'s form from content.php to stand-alone form class to hide the title field',
    'Form/Admin/Settings/Performance.php' => 'Updated text for APCu Extension and updated description of type field',
    'controllers/AdminContentController.php' => 'Hide search check box in Layout Editor\'s page editing form for non-custom pages',
    'controllers/AdminSettingsController.php' => 'Fixed issue: "APC and Memcache caching options giving error when enabled while respective extensions are not installed" and updated label of disabled caching options',
    'views/scripts/admin-settings/performance.tpl' => 'Added the "disabled" style class for disabled caching options',
    'Bootstrap.php' => 'Set the unique salt for form',
  ),
  '4.8.10' => array(
    'settings/install.php' => 'Fixed typo in Search Page title',
    'settings/changelog.php' => 'Incremented version',
    'settings/manifest.php' => 'Incremented version',
    'settings/my.sql' => 'Incremented version',
    'controllers/AdminContentController.php' => 'Fixed log error "Undefined index: levels"',
    'controllers/LinkController.php' => 'Fixed log error "The subject must be an instance of Core_Model_Item_Abstract" and Updated code to fetch description from og:description tag when adding a link from activity feed if description meta-tag has not been not set for that page',
    'Plugin/Core.php' => 'Fixed issue with post sharing not working when Janrain integration is enabled and security warnings appearing on SSL enabled websites when using VigLink.',
  ),
  '4.8.9' => array(
