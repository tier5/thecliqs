...
class Ynmediaimporter_Provider_Flickr extends Ynmediaimporeter_Provider_Abstract
{
     ...
     */
    public function _getAlbums($params = array(), $cache = true)
    {
     ...
     */
    public function _getPhotos($params = array(), $cache = true)
    {
        $cache = 0;
     ...
     */
    public function _getFavourites($params = array(), $cache = true)
    {
        $cache = 0;
        $media_parent =  isset($params['media_parent']) ? $params['media_parent'] : null;
