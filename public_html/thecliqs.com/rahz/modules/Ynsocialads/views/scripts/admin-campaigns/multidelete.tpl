...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      ...
      <p>
        <?php echo $this->translate("Are you sure that you want to delete %d campaigns?", $this->count) ?>
      </p>
      <br />
      <p>
  ...
  <form>
    <div>
      <h3><?php echo $this->translate("Delete the selected campaigns?") ?></h3>
      <p>
        <?php echo $this->translate("Please select at least one campaign to delete.") ?>
      </p>
      <br/>
