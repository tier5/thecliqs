...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Delete the selected ads?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to delete the %d ads?", $this->count) ?>
      </p>
      <br />
      <p>
  ...
  <form>
    <div>
      <h3><?php echo $this->translate("Delete the selected ad?") ?></h3>
      <p>
        <?php echo $this->translate("Please select an ads to delete.") ?>
      </p>
      <br/>
