  ...
  window.addEvent('domready', function() { // wait for the content
    ...
    var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
      ...
      onComplete: function hideProgress() {
        ...
        var demosubmit = document.getElementById("submit");

        demostatuscurrent.style.display = "none";
        demostatusoverall.style.display = "none";
        demosubmit.style.display = "inline-block";
      },
      ...
      onFileRemove: function(file) {
        ...
        var file_id = $('fancyuploadfileids').value;
        request = new Request.JSON({
          'format' : 'json',
          'url' : '<?php echo $this->url(array('module' => 'suggest', 'controller' => 'index', 'action' => 'delete-photo'), 'default') ?>',
          'data': {
            'photo_id' : file_id
          },
          'onSuccess' : function(responseJSON) {
            ...
            $('demo-browse').style.display = "inline";

            $('photo-uploader').removeClass('hidden');
            $('photo-view').addClass('hidden');
            $('photo-view').innerHTML = '';
      ...
      onFileSuccess: function(file, response) {
        ...
        if (json.get('status') == '1') {
          ...
          $('fancyuploadfileids').value = json.get('photo_id');
          ...
          $('photo-uploader').addClass('hidden');
          $('photo-view').removeClass('hidden');
          var img = new Element('img', {src:json.get('photo_url'), class: 'suggest-photo-view'});
          $('photo-view').appendChild(img);
...
<input type="hidden" name="file_id" id="fancyuploadfileids" value=""/>
<fieldset id="demo-fallback">
  <legend><?php echo $this->translate('suggest_profile_photo_form_header');?></legend>
  <p>
    <?php echo $this->translate('suggest_profile_photo_form_description');?>
  </p>
  <label for="demo-photoupload">
    <?php echo $this->translate('suggest_profile_photo_form_file');?>
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('suggest_profile_photo_fancy_description');?>
  </div>
  <div>
    <a class="buttonlink icon_photos_new" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('suggest_profile_photo_fancy_link');?></a>
...
<div id="photo-view" class="hidden"></div>

<ul id="demo-list"></ul>

<div id="html_field-wrapper"></div>
