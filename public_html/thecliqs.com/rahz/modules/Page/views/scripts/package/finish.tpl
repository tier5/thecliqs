 ...
 * @version    $Id: finish.tpl 8221 2011-07-25 00:24:02Z taalay $
 * @author     Taalay (TJ)
 */
?>

<form method="get" action="<?php echo $this->url(array('action'=>'edit', 'page_id'=>$this->page->getIdentity()), 'page_team'); ?>"
