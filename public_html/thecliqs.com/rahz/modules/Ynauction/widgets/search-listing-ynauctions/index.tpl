...
<?php if($homeres->getTotalItemCount() <= 0): ?>              
      ...
      <span>
           <?php echo $this->translate('Nobody has post an auction with that criteria.');?>
      </span>
           <div style="clear: both;"></div>
    </div>
 
<?php else: $now = date('Y-m-d H:i:s');?>
<ul class="global_form_box" style="background: none; margin-bottom: 15px; overflow: auto; margin-right: 15px;" > 
...
<li>
            <div valign='top' style='text-align: center; padding-top:6px;  padding-bottom:6px; float: left; position:relative;'>
                 <?php if($data->getPhotoUrl() != ""): ?>  
                   <a href="<?php echo $data->getHref()?>" title="<?php echo $data->title?>"><img src="<?php echo $data->getPhotoUrl("thumb.normal")?>" style = "width:100px; padding-left: 2px;" /></a>
                 <?php else: ?>
                    <img src="./application/modules/Ynauction/externals/images/nophoto_product_thumb_normal.png" title="<?php echo $data->title?>" style = "max-width:100px;max-height:100px; padding-left: 2px;" />                                                                                                             
                <?php endif; ?>   
            ...
            <div valign='top' class="contentbox" style="width: 80%; padding-left: 20px; float: left; padding-bottom: 10px;" >
                ...
                <div class="ynauctions_browse_date">
                 ...
                 <div class="ynclockcont" id="clockcont">
                     ...
                     <div class="clock">
                         ...
                         <?php if($data->status != 0 || $data->end_time < $now):?>
                 ...
                 <?php if($data->status == 0): ?>
                    <div class="group_price" style="width: 125px;">
                    ...
                    <?php else:?>
                    <div class="group_price" style="height: 40px;"></div>
                     <?php endif;    ?>
                 </div>   
            </div>
 </li>
 <?php endforeach; endif;?>
 <?php echo $this->paginationControl($this->homeres, null, array("pagination/auctionpagination.tpl","ynauction"), array()); ?>
 </ul>