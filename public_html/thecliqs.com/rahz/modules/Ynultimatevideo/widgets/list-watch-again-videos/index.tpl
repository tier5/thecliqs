<div id="ynultimatevideo_list_item_browse_<?php echo $this->identity; ?>" class="<?php echo $this -> class_mode;?>">
    <div id="ynultimatevideo_tabs_browse" class="clearfix">
...
<script type="text/javascript">
    ...
    var ynultimatevideo_view_simple_browse<?php echo $this->identity ?> = function()
    {
        document.getElementById('ynultimatevideo_list_item_browse_<?php echo $this->identity; ?>').set('class','ynultimatevideo_simple-view');
        setCookie('browse_view_mode-<?php echo $this->identity ?>','simple');
    };

    var ynultimatevideo_view_grid_browse<?php echo $this->identity ?> = function()
    {
        document.getElementById('ynultimatevideo_list_item_browse_<?php echo $this->identity; ?>').set('class','ynultimatevideo_grid-view');
        setCookie('browse_view_mode-<?php echo $this->identity ?>','grid');
    };

    var ynultimatevideo_view_list_browse<?php echo $this->identity ?> = function()
    {
        document.getElementById('ynultimatevideo_list_item_browse_<?php echo $this->identity; ?>').set('class','ynultimatevideo_list-view');
